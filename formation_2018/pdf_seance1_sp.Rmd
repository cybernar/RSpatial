...
Heureusement le package **sf** est arrivé ! Il est beaucoup plus rapide et simple d'utilisation. Mais il introduit un nouveau modèle de données différent de **sp**.
...
![](media/original/asdar_p35.png){width=400px}
