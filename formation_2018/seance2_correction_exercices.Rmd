...
Avec *tmap*, affichez le NDVI et le contour des communes en noir. Avec `?tm_polygons`, 
cherchez la fonction qui permet d'afficher uniquement le contour des polygones sans 
remplissage. Avec la fonction `tm_text`, affichez les noms des communes, tirés de la 
colonne __nom__.

```{r exerciceA_tmap, warning=FALSE}
...
tm_shape(trace_rando) +
  tm_lines(col="black", lwd=2, lty="dotted") 
```
